...
<div class="container mt-5">
    ...
    <?php
    if (isset($_POST['nama'], $_POST['nim'], $_POST['kelas'], $_POST['mata_kuliah'], $_POST['nilai'], $_POST['nilai2'], $_POST['uts'], $_POST['uas'], $_POST['absen'])) {
        $nama = $_POST['nama'];
        $nim = $_POST['nim'];
        $kelas = $_POST['kelas'];
        ...
        $total_nilai = $nilai + $nilai2 + $uts + $uas + $absen;
...
zA
        ...
        echo "Nilai1: $nilai<br>";
        echo "Nilai2: $nilai2<br>";
        echo "UTS: $uts<br>";
        echo "UAS: $uas<br>";
        echo "Absen: $absen<br>";
        echo "Total Nilai: $total_nilai ", "grade: $grade";
        echo "</div>";
    } else {
